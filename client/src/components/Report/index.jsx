...
const Report = () => {
    ...
    return (
        <div className="container mx-auto text-center">
            <h3 className="mb-4 uppercase font-bold">Báo cáo hàng ngày {from_date}</h3>
                    ...
                    {data && data.map((item, index) => {
                        return (
                            <tr key={index}>
                                ...
                                <td className="border border-slate-700">
                                    <a className="text-blue-600" href={`/work/diary/report/${id}/${item.Vehicle.id}`}>{item.Vehicle.name}</a>
                                </td>
                                <td className="border border-slate-700">
                                    {item.Vehicle.code}
                                </td>
