...
export const Container = ({ children }) => (
  <div className="min-h-692 fixed bottom-0 left-0 right-0 top-0 z-0 overflow-hidden bg-gradient-to-r from-yellow-600 to-yellow-200">
    {children}
  </div>
);
...
export const FormMain = ({ children, ...rest }) => (
  <Form
...
export const FormButton = ({ children }) => (
  <button className="bg-purple-500 py-4 px-0 border-none rounded-md text-white text-xl cursor-pointer">
    {children}
  </button>
);
