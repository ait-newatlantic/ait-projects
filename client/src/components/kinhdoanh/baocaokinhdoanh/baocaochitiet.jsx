                                        ...
                                        <tbody >
                                            ...
                                            {!!yearResult2 && yearResult2.map(model => (
                                                <tr className="content" key={model.id}>
                                                    ...
                                                    <td>{Math.round(parseInt(model.nvl_total_s) / parseInt(model.total) * 1000)/100}%</td>
                                                </tr>
                                            ))}
                                            {!!yearResult2 && yearResult2.map(model => (
                                                <tr className="content" key={model.id}>
                                                    ...
                                                    <td>{Math.round(parseInt(model.lamdong_total_s) / parseInt(model.total) * 1000)/100}%</td>
                                                </tr>
                                            ))}
                                            {!!yearResult2 && yearResult2.map(model => (
                                                <tr className="content" key={model.id}>
