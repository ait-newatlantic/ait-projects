...
export default function EmployeeDemandList() {
    ...
    useEffect(() => {
        handleSubmit()
    }, [branch_name, demand_employee_name, province_name, customer_type_name, contact_type_name, demand_status_name, car_model_name, car_type_name, from_date, to_date])
        ...
        <div>
            <div className="row">
                ...
                <div className="col d-flex justify-content-end">
                    <div>
                        <Link to="/dashboard/employee/demands/list/history" className="btn btn-sm btn-hover" role="button">
                    ...
                    <div>
                        <Link to="/dashboard/Employee/demands/input" className="btn btn-sm btn-hover" role="button">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 col-md-3  ">
                            ...
                            <Autocomplete
                                ...
                                options={customer_types.map((option) => option.customer_type_name)}
                                renderInput={(params) => <TextField {...params} variant="standard" />}
                            />
                        ...
                        <div className="col-sm-6 col-md-3  ">
                            ...
                            <Autocomplete
                                ...
                                options={contact_types.map((option) => option.contact_type_name)}
                                renderInput={(params) => <TextField {...params} variant="standard" />}
                            />
                        ...
                        <div className="col-sm-6 col-md-3  ">
                            ...
                            <Autocomplete
                                ...
                                options={demand_statuses.map((option) => option.demand_status_name)}
                                renderInput={(params) => <TextField {...params} variant="standard" />}
                            />
            ...
            <TableContainer className="table-container">
                <Table id="emp" stickyHeader aria-label="sticky table">
                    ...
                    <TableBody>
                        {demandResult.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => {
                            return (
                                <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                                    ...
                                    <TableCell
                                        ...
                                        style={{ minWidth: "'auto'" }}
                                    >
                                        <Link className="text-primary" to={`/dashboard/demands/update/` + btoa(`${row.id}`)}>
